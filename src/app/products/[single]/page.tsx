...
export default async function Single({params}:any){
  
  const {id, title, description, tags, price, thumbnail } = await singleProductData(SingleProductQuery, {handle: params.single})
  ...
  <div className="pt-6">
      ...
      <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <li>
          <div className="flex items-center">
            <a href="#" className="mr-2 text-sm font-medium text-gray-900">Produits</a>
        ...
        <li className="text-sm">
          <a href="#" aria-current="page" className="font-medium text-gray-500 hover:text-gray-600">{title}</a>
        </li>
      </ol>
    </nav>
        ...
        <div className="mt-10">
          ...
          <div className="mt-4">
            <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
              <li className="text-gray-400"><span className="text-gray-600">{tags[0]}</span></li>
              <li className="text-gray-400"><span className="text-gray-600">{tags[1]}</span></li>
              <li className="text-gray-400"><span className="text-gray-600">{tags[2]}</span></li>
            </ul>
          </div>
        </div>
    ...
    <div>
      ...
      <RelatedProduct handle={params.single}/>
    </div>
  </div>
</div>
  )
